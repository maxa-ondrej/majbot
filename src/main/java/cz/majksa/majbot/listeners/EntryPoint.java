/*
 *  majbot - cz.majksa.majbot.listeners.EntryPoint
...
/**
 * <p><b>Class {@link cz.majksa.majbot.listeners.EntryPoint}</b></p>
 *
 * @author majksa
 * @version 1.0.0
 * @since 1.0.0
...
public class EntryPoint<T extends GenericEvent> {
     ...
     *
     * @see cz.majksa.majbot.listeners.EntryPointList#register(EntryPoint)
     */
     ...
     *
     * @see cz.majksa.majbot.listeners.EntryPointList#unregister(EntryPoint)
     */
